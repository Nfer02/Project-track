...
export function Logo({ size = 32, className }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      {/* Columna izquierda (barra vertical de la P) */}
      ...
      {/* Cara exterior derecha del arco */}
      ...
      {/* Sombra ambiental */}
      <ellipse cx="135" cy="292" rx="80" ry="8" fill="rgba(59,130,246,0.08)" />
    </svg>
  )
}
